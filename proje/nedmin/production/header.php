            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="index1.php"><i class="fa fa-home"></i> Anasayfa </a></li>
                  <li><a href="hakkimizdaayar.php"><i class="fa fa-info"></i> Hakkımızda </a>
                  </li>
                  ...
                  <li><a><i class="fa fa-cogs"></i> Site Ayarları <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="sosyalayar.php">Sosyal Medya Ayarlar</a></li>
